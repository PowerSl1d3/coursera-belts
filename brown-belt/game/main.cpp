...
public:
    ...
    geo2d::Point GetPos() const { return position_point; }
private:
    geo2d::Point position_point;
};

class Building : public GameObject {
public:
    explicit Building(geo2d::Rectangle geometry)
    : position_rectangle(geometry)
    {}
    ...
    virtual bool CollideWith(const Tower& that) const override;
    virtual bool CollideWith(const Fence& that) const override;
    geo2d::Rectangle GetPos() const { return position_rectangle; }
private:
    geo2d::Rectangle position_rectangle;
};

class Tower : public GameObject {
public:
    explicit Tower(geo2d::Circle geometry)
    : position_circle(geometry)
    {}
    ...
    virtual bool CollideWith(const Tower& that) const override;
    virtual bool CollideWith(const Fence& that) const override;
    geo2d::Circle GetPos() const { return position_circle; }
private:
    geo2d::Circle position_circle;
};

class Fence : public GameObject {
public:
    explicit Fence(geo2d::Segment geometry)
    : position_segment(geometry)
    {}
    ...
    virtual bool CollideWith(const Tower& that) const override;
    virtual bool CollideWith(const Fence& that) const override;
    geo2d::Segment GetPos() const { return position_segment; }
private:
    geo2d::Segment position_segment;
};
...
bool Unit::CollideWith(const Unit& that) const {
    ...
    return geo2d::Collide(this->position_point, that.position_point);
}

bool Unit::CollideWith(const Building &that) const {
    return geo2d::Collide(this->position_point, that.GetPos());
}
...
bool Building::CollideWith(const Unit &that) const {
    return geo2d::Collide(this->position_rectangle, that.GetPos());
}
...
bool Building::CollideWith(const Building &that) const {
    ...
    return geo2d::Collide(this->position_rectangle, that.position_rectangle);
}
...
bool Tower::CollideWith(const Unit &that) const {
    return geo2d::Collide(this->position_circle, that.GetPos());
}
...
bool Tower::CollideWith(const Tower &that) const {
    ...
    return geo2d::Collide(this->position_circle, that.position_circle);
}
...
bool Fence::CollideWith(const Unit &that) const {
    return geo2d::Collide(this->position_segment, that.GetPos());
}
...
bool Fence::CollideWith(const Fence &that) const {
    ...
    return geo2d::Collide(this->position_segment, that.position_segment);
}
