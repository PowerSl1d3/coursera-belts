...
public:
  ...
  public:
    ...
    IndexProxy(Polynomial& p, size_t d)
      : poly_(p)
      , degree_(d)
    {}

    friend std::istream& operator<<(std::istream& is, const IndexProxy& p) {
      is << p;
      return is;
    }
	...
	return 0 != v;
      ...
      return poly_.coeffs_[degree_] != v;
    }
